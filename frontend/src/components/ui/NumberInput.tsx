...
export const NumberInput = forwardRef<HTMLInputElement, NumberInputProps>(function NumberInput(
  ...
  return (
    <input
      ...
      className={cn(
        controlClass,
        // Tabular figures so a clamped value does not shift the caret, and the
        // native spinners hidden: they are ugly at this size and the field is
        // already keyboard-steppable.
        'tnum [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none',
        className,
      )}
      {...rest}
    />
